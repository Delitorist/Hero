...
/* Private typedef -----------------------------------------------------------*/
/* USER CODE BEGIN PTD */
osThreadId imuTaskHandle;                  //ÍÓÂÝÒÇÈÎÎñ
osThreadId shoot_handle;                   //shootÈÎÎñ
osThreadId battery_voltage_handle;         //µçÑ¹¼ì²â
osThreadId servo_task_handle;              //¶æ»ú
osThreadId imuTaskHandle;                  //ÍÓÂÝÒÇ
osThreadId chassisTaskHandle;              //µ×ÅÌ
osThreadId gimbalTaskHandle;               //ÔÆÌ¨
osThreadId detect_handle;                  //¼ì²â
osThreadId usb_task_handle;                //usb
osThreadId referee_usart_task_handle;      //²ÃÅÐÏµÍ³
